...
public void autoid() {
    ...
    private void initComponents() {
        ...
        lblid.setFont(new java.awt.Font("Nirmala UI", 1, 20)); // NOI18N
    ...
    if (id.isEmpty() || first.isEmpty() || last.isEmpty() || nic.isEmpty() || pass.isEmpty() || 
        address.isEmpty() || bd.isEmpty() || gender.isEmpty() || contact.isEmpty() || userimage == null) {
        JOptionPane.showMessageDialog(this, "Please fill in all fields (including photo).", "Input Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    try {
        ...
        // Optionally clear the form for new entry
        txtfirstnm.setText("");
        txtlastnm.setText("");
        txtnic.setText("");
        txtpass.setText("");
        ...
        lblimg.setIcon(null);
        userimage = null;
        autoid(); // Generate new customer ID
